...
![Common causal questions presented as causal graphs, adapted from Bulbulia (2024)](figures/common-causal-questions.svg)

### A typology of measurement error bias

![A typology of measurement error bias, adapted from Bulbulia (2024)](figures/measurementerrorbias.svg)

### Threats to external validity

![Threats to external validity, adapted from Bulbulia (2024)](figures/externalvalidity.svg)
