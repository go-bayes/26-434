...
Slides are available separately (not embedded in the mdBook site).
...
- You will need it for your final report (if you choose report option).
...
3. If you are familiar with version control, you can initialise a Git repository when creating a new project. If not, do not worry about it.
